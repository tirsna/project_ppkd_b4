// File: lib/models/chekcinmodels.dart

import 'dart:convert';

Chekcinmodels chekcinmodelsFromJson(String str) => Chekcinmodels.fromJson(json.decode(str));

String chekcinmodelsToJson(Chekcinmodels data) => json.encode(data.toJson());
...
class Chekcinmodels {
    ...
    factory Chekcinmodels.fromJson(Map<String, dynamic> json) => Chekcinmodels(
